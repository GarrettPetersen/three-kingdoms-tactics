    ...
    return {
        ...
        "zhujun": {
            ...
            "layers": [
                ...
                (
                    "helmet_conical.png",
                    {
                        (142, 142, 142, 255): (218, 206, 170, 255),
                        (103, 103, 103, 255): (118, 110, 92, 255),
                        (168, 64, 32, 255): (230, 230, 230, 255),
                        (142, 54, 27, 255): (158, 158, 158, 255),
                    },
                ),
            ],
            "manual_palette": {
        ...
        "palace_assassin": {
            ...
            "layers": [
                ...
                ("hat_official_tall.png", {
                    (206, 74, 54, 255): (113, 52, 60, 255),
                    (81, 18, 20, 255): (42, 15, 19, 255),
                    (231, 182, 45, 255): (132, 126, 118, 255),
                    (196, 158, 52, 255): (78, 72, 72, 255),
                }),
            ],
            "manual_palette": {
                "skin_tones": {
