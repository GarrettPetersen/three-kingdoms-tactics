...
export const LIUBO_GRAPH = {
    l_top_left: ['l_top_right', 't_top_outer'],
    l_top_right: ['corner_nw_top', 'corner_ne_top', 'l_top_left'],
    l_right_top: ['l_right_bottom', 't_right_outer'],
    l_right_bottom: ['corner_ne_right', 'corner_se_right', 'l_right_top'],
    l_bottom_right: ['l_bottom_left', 't_bottom_outer'],
    l_bottom_left: ['corner_se_bottom', 'corner_sw_bottom', 'l_bottom_right'],
    l_left_bottom: ['l_left_top', 't_left_outer'],
    l_left_top: ['corner_sw_left', 'corner_nw_left', 'l_left_bottom'],

    corner_ne_top: ['l_top_right', 'corner_ne_right', 'circle_ne'],
    corner_ne_right: ['l_right_bottom', 'corner_ne_top', 'circle_ne'],
    corner_se_right: ['l_right_bottom', 'corner_se_bottom', 'circle_se'],
    corner_se_bottom: ['l_bottom_left', 'corner_se_right', 'circle_se'],
    corner_sw_bottom: ['l_bottom_left', 'corner_sw_left', 'circle_sw'],
    corner_sw_left: ['l_left_top', 'corner_sw_bottom', 'circle_sw'],
    corner_nw_left: ['l_left_top', 'corner_nw_top', 'circle_nw'],
    corner_nw_top: ['l_top_right', 'corner_nw_left', 'circle_nw'],
    ...
    t_top_outer: ['l_top_left', 't_top_inner'],
    t_top_inner: ['t_top_outer', 'pond'],
    t_right_outer: ['l_right_top', 't_right_inner'],
    t_right_inner: ['t_right_outer', 'pond'],
    t_bottom_outer: ['l_bottom_right', 't_bottom_inner'],
    t_bottom_inner: ['t_bottom_outer', 'pond'],
    t_left_outer: ['l_left_bottom', 't_left_inner'],
