...
| **Tiny5** | `Tiny5-Regular.ttf` | 8px | **8px**, **16px**, **24px**, … | Stefan Schmidt. Variable-width 5-pixel cap height with spacing above/below → effective 8px. Use for body, tooltips, labels. |
...
- Avoid sizes that aren’t multiples of the design size (e.g. 10px for Silkscreen/Dogica)—they will look soft. **Tiny5** design size is 8px (5px cap + spacing); use **8px**, **16px**, **24px**, … only.
...
- **Tiny5**: [GitHub font_tiny5](https://github.com/Gissio/font_tiny5) — “variable-width, 5-pixel font”; use at 8px (or 16px, 24px) for crisp rendering (5px cap + line spacing).
